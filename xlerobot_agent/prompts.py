...
def build_exploration_policy_system_prompt() -> str:
    return (
        ...
        "This is physical robot exploration: prefer nearby reachable frontiers when they provide comparable new navigable floor-space gain, and only cross the map for a clearly better frontier. "
...
def build_exploration_policy_user_prompt(payload: dict[str, Any]) -> str:
    ...
    sections = [
        ...
        (
            ...
            "unknown space. The list may contain currently visible RGB-D frontier observations and reachable stored "
            "frontier-memory points from previous scans; current observations come from currently scanned RGB-D evidence. "
            ...
            "If `currently_visible` is false, treat the item as a memory candidate and choose it with "
...
def _compact_frontier_record_for_prompt(record: dict[str, Any], *, include_geometry: bool) -> dict[str, Any]:
    compact = {
        ...
        "currently_visible": record.get("currently_visible"),
